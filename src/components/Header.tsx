export function Header() {
  return (
    <header className="text-center pt-8 pb-4 px-4">
      <p className="uppercase tracking-[0.3em] text-saffron text-xs sm:text-sm font-semibold">
        Limerick GAA &middot; 1990 - 2026
      </p>
      <h1 className="text-3xl sm:text-5xl font-extrabold text-shadow mt-2">
